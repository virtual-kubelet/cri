...
import (
	...
	"github.com/virtual-kubelet/cri/cmd/virtual-kubelet/commands/providers"
	"github.com/virtual-kubelet/cri/cmd/virtual-kubelet/commands/root"
	"github.com/virtual-kubelet/cri/cmd/virtual-kubelet/commands/version"
...
func main() {
	...
	opts.Version = strings.Join([]string{k8sVersion, "vk-cri", buildVersion}, "-")
